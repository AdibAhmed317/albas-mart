...
const Footer = () => {
  return (
    <footer class='p-4 sm:p-6 bg-green-200 mt-10'>
      <div class='md:flex md:justify-between'>
        ...
        <div class='grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3'>
          <div>
            <h2 class='mb-6 text-sm font-semibold uppercase text-green-900'>
              Locations
            </h2>
          ...
          <div>
            <h2 class='mb-6 text-sm font-semibold text-green-900 uppercase'>
              Follow us
            </h2>
            <ul class='text-green-900'>
              <li class='mb-4'>
