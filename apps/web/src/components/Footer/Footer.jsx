    ...
    <footer className='p-4 sm:p-6 bg-primaryBlue'>
      <div className='md:flex md:justify-between'>
        ...
        <div className='grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3'>
          <div>
            <h2 className='mb-6 text-sm font-semibold uppercase text-black/80'>
              Locations
            </h2>
          ...
          <div>
            <h2 className='mb-6 text-sm font-semibold text-black/80 uppercase'>
              Follow us
            </h2>
            <ul className='text-black/80'>
              <li className='mb-4'>
      ...
      <hr className='my-6 sm:mx-auto border-black/80 lg:my-8' />
      <div className='sm:flex sm:items-center sm:justify-between'>
        <span className='text-sm text-black/80 sm:text-center'>
          © 2024{' '}
          <a href='#' className='hover:underline'>
            Albas Mart™
          </a>
