      ...
      >
        <div className='max-w-6xl max-lg:max-w-3xl mx-auto bg-primaryBlue rounded-lg my-40 md:mt-6'>
          <div className='grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]'>
            <div>
              <h1 className='text-4xl font-bold text-black/80'>Get in Touch</h1>
              <p className='text-sm text-black/75 mt-4 leading-relaxed'>
              ...
              <ul className='mt-12 space-y-8'>
                <li className='flex items-center'>
                  ...
                  <a
                    ...
                    className='text-black/80 text-sm ml-4'
                  >
                    info@example.com
                  </a>
                </li>
              ...
              <ul className='flex mt-12 space-x-4'>
                <li className='bg-primaryRed hover:bg-primaryGreen h-10 w-10 rounded-full flex items-center justify-center shrink-0'>
            ...
            <div className='bg-blue-100 p-6 rounded-lg'>
              <form className='mt-8 space-y-4'>
                <input
                  type='text'
                  placeholder='Name'
                  className='w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-primaryRed'
                />
                <input
                  type='email'
                  placeholder='Email'
                ...
                <textarea
                  placeholder='Message'
                  rows='6'
                  className='w-full rounded-lg px-4 text-gray-800 text-sm pt-3 outline-primaryRed'
                ></textarea>
                <button
                  type='button'
                  className='text-white bg-primaryRed hover:bg-primaryGreen tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full'
                >
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    width='16px'
